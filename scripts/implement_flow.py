...
def build_task_summary(track_dir: Path) -> dict[str, object]:
    ...
    return {
        ...
        "workflow": {
            ...
            "requires_tdd": workflow_policy["requires_tdd"],
            ...
            "ci_aware_commands": workflow_policy["ci_aware_commands"],
            "requires_documentation_updates": workflow_policy["requires_documentation_updates"],
            "requires_type_safety": workflow_policy["requires_type_safety"],
            "requires_static_analysis": workflow_policy["requires_static_analysis"],
            "requires_mobile_verification": workflow_policy["requires_mobile_verification"],
            ...
            "setup_commands": workflow_policy["setup_commands"],
        ...
        "checkpoints": [
            ...
            "Write failing tests first when workflow.md requires TDD.",
            "Run the workflow-required test/verification loop.",
            "Use CI-aware non-interactive commands when workflow.md requires them.",
